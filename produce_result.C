...
//  gStyle->SetFillStyle(ROOT.kWhite) ;
  ...
  float moreone_data_ex_B_total=0;
  float moreone_data_ex_B_err_total=0;
  float moreone_data_in_B_total=0;
  float moreone_data_in_B_err_total=0;
  float moreone_MC_ex_B_total=0;
  float moreone_MC_ex_B_err_total=0;
  float moreone_MC_in_B_total=0;
  float moreone_MC_in_B_err_total=0;
  float moreone_data_ex_E_total=0;
  float moreone_data_ex_E_err_total=0;
  float moreone_data_in_E_total=0;
  float moreone_data_in_E_err_total=0;
  float moreone_MC_ex_E_total=0;
  float moreone_MC_ex_E_err_total=0;
  float moreone_MC_in_E_total=0;
  float moreone_MC_in_E_err_total=0;
 
  float two_data_ex_B_total=0;
  float two_data_ex_B_err_total=0;
  float two_data_in_B_total=0;
  float two_data_in_B_err_total=0;
  float two_MC_ex_B_total=0;
  float two_MC_ex_B_err_total=0;
  float two_MC_in_B_total=0;
  float two_MC_in_B_err_total=0;
  float two_data_ex_E_total=0;
  float two_data_ex_E_err_total=0;
  float two_data_in_E_total=0;
  float two_data_in_E_err_total=0;
  float two_MC_ex_E_total=0;
  float two_MC_ex_E_err_total=0;
  float two_MC_in_E_total=0;
  float two_MC_in_E_err_total=0;

  float eff_data_ex_B_total=0;
  float eff_data_ex_B_err_total=0;
  float eff_data_in_B_total=0;
  float eff_data_in_B_err_total=0;
  float eff_MC_ex_B_total=0;
  float eff_MC_ex_B_err_total=0;
  float eff_MC_in_B_total=0;
  float eff_MC_in_B_err_total=0;
  float eff_data_ex_E_total=0;
  float eff_data_ex_E_err_total=0;
  float eff_data_in_E_total=0;
  float eff_data_in_E_err_total=0;
  float eff_MC_ex_E_total=0;
  float eff_MC_ex_E_err_total=0;
  float eff_MC_in_E_total=0;
  float eff_MC_in_E_err_total=0;

  float ratio_B_in_total=0;
  float ratio_B_in_err_total=0;
  float ratio_B_ex_total=0;
  float ratio_B_ex_err_total=0;
  float ratio_E_in_total=0;
  float ratio_E_in_err_total=0;
  float ratio_E_ex_total=0;
  float ratio_E_ex_err_total=0;
...
//   if(j%10000==0) std::cout<<"N="<<j<<std::endl;
 ...
 for(int L=0;L<10;L++){
                      moreone_data_ex_B[L]=moreone_N_data_B[L]-0.006735*(moreone_N_TT_1_B[L]+moreone_N_TT_2_B[L])-0.10259*(moreone_N_WJet_1_B[L]+moreone_N_WJet_2_B[L]);
			    moreone_data_ex_B_err[L]=sqrt(moreone_data_ex_B[L]);
                      two_data_ex_B[L]=two_N_data_B[L]-0.006735*(two_N_TT_1_B[L]+two_N_TT_2_B[L])-0.10259*(two_N_WJet_1_B[L]+two_N_WJet_2_B[L]);
			    two_data_ex_B_err[L]=sqrt(two_data_ex_B[L]);
                      moreone_MC_in_B[L]=0.01679*moreone_N_DY_B[L]+0.006735*(moreone_N_TT_1_B[L]+moreone_N_TT_2_B[L])+0.10259*(moreone_N_WJet_1_B[L]+moreone_N_WJet_2_B[L]);
			    moreone_MC_in_B_err[L]=sqrt(moreone_MC_in_B[L]);
                      two_MC_in_B[L]=0.01679*two_N_DY_B[L]+0.006735*(two_N_TT_1_B[L]+two_N_TT_2_B[L])+0.10259*(two_N_WJet_1_B[L]+two_N_WJet_2_B[L]);
			    two_MC_in_B_err[L]=sqrt(two_MC_in_B[L]);
                      moreone_MC_ex_B[L]=0.01679*moreone_N_DY_B[L]+0.01347*(moreone_N_TT_1_B[L]-moreone_N_TT_2_B[L])+0.20518*(moreone_N_WJet_1_B[L]-moreone_N_WJet_2_B[L]);
			    moreone_MC_ex_B_err[L]=sqrt(moreone_MC_ex_B[L]);
                      two_MC_ex_B[L]=0.01679*two_N_DY_B[L]+0.01347*(two_N_TT_1_B[L]-two_N_TT_2_B[L])+0.20518*(two_N_WJet_1_B[L]-two_N_WJet_2_B[L]);
			    two_MC_ex_B_err[L]=sqrt(two_MC_ex_B[L]);

			    moreone_data_ex_B_total=moreone_data_ex_B_total+moreone_data_ex_B[L];
			    moreone_data_ex_B_err_total=sqrt(moreone_data_ex_B_total);
			    two_data_ex_B_total=two_data_ex_B_total+two_data_ex_B[L];
			    two_data_ex_B_err_total=sqrt(two_data_ex_B_total);

			    moreone_data_in_B_total=moreone_data_in_B_total+moreone_N_data_B[L];
			    moreone_data_in_B_err_total=sqrt(moreone_data_in_B_total);
			    two_data_in_B_total=two_data_in_B_total+two_N_data_B[L];
			    two_data_in_B_err_total=sqrt(two_data_in_B_total);
                      
			    moreone_MC_ex_B_total=moreone_MC_ex_B_total+moreone_MC_ex_B[L];
			    moreone_MC_ex_B_err_total=sqrt(moreone_MC_ex_B_total);
			    two_MC_ex_B_total=two_MC_ex_B_total+two_MC_ex_B[L];
			    two_MC_ex_B_err_total=sqrt(two_MC_ex_B_total);

			    moreone_MC_in_B_total=moreone_MC_in_B_total+moreone_MC_in_B[L];
			    moreone_MC_in_B_err_total=sqrt(moreone_MC_in_B_total);
			    two_MC_in_B_total=two_MC_in_B_total+two_MC_in_B[L];
			    two_MC_in_B_err_total=sqrt(two_MC_in_B_total);
                      }

 for(int M=0;M<4;M++){
                      moreone_data_ex_E[M]=moreone_N_data_E[M]-0.006735*(moreone_N_TT_1_E[M]+moreone_N_TT_2_E[M])-0.10259*(moreone_N_WJet_1_E[M]+moreone_N_WJet_2_E[M]);
			    moreone_data_ex_E_err[M]=sqrt(moreone_data_ex_E[M]);
                      two_data_ex_E[M]=two_N_data_E[M]-0.006735*(two_N_TT_1_E[M]+two_N_TT_2_E[M])-0.10259*(two_N_WJet_1_E[M]+two_N_WJet_2_E[M]);
			    two_data_ex_E_err[M]=sqrt(two_data_ex_E[M]);
                      moreone_MC_in_E[M]=0.01679*moreone_N_DY_E[M]+0.006735*(moreone_N_TT_1_E[M]+moreone_N_TT_2_E[M])+0.10259*(moreone_N_WJet_1_E[M]+moreone_N_WJet_2_E[M]);
			    moreone_MC_in_E_err[M]=sqrt(moreone_MC_in_E[M]);
                      two_MC_in_E[M]=0.01679*two_N_DY_E[M]+0.006735*(two_N_TT_1_E[M]+two_N_TT_2_E[M])+0.10259*(two_N_WJet_1_E[M]+two_N_WJet_2_E[M]);
			    two_MC_in_E_err[M]=sqrt(two_MC_in_E[M]);
                      moreone_MC_ex_E[M]=0.01679*moreone_N_DY_E[M]+0.01347*(moreone_N_TT_1_E[M]-moreone_N_TT_2_E[M])+0.20518*(moreone_N_WJet_1_E[M]-moreone_N_WJet_2_E[M]);
			    moreone_MC_ex_E_err[M]=sqrt(moreone_MC_ex_E[M]);
                      two_MC_ex_E[M]=0.01679*two_N_DY_E[M]+0.01347*(two_N_TT_1_E[M]-two_N_TT_2_E[M])+0.20518*(two_N_WJet_1_E[M]-two_N_WJet_2_E[M]);
			    two_MC_ex_E_err[M]=sqrt(two_MC_ex_E[M]);
                      
 
			    moreone_data_ex_E_total=moreone_data_ex_E_total+moreone_data_ex_E[M];
			    moreone_data_ex_E_err_total=sqrt(moreone_data_ex_E_total);
			    two_data_ex_E_total=two_data_ex_E_total+two_data_ex_E[M];
			    two_data_ex_E_err_total=sqrt(two_data_ex_E_total);

			    moreone_data_in_E_total=moreone_data_in_E_total+moreone_N_data_E[M];
			    moreone_data_in_E_err_total=sqrt(moreone_data_in_E_total);
			    two_data_in_E_total=two_data_in_E_total+two_N_data_E[M];
			    two_data_in_E_err_total=sqrt(two_data_in_E_total);
                      
			    moreone_MC_ex_E_total=moreone_MC_ex_E_total+moreone_MC_ex_E[M];
			    moreone_MC_ex_E_err_total=sqrt(moreone_MC_ex_E_total);
			    two_MC_ex_E_total=two_MC_ex_E_total+two_MC_ex_E[M];
			    two_MC_ex_E_err_total=sqrt(two_MC_ex_E_total);

			    moreone_MC_in_E_total=moreone_MC_in_E_total+moreone_MC_in_E[M];
			    moreone_MC_in_E_err_total=sqrt(moreone_MC_in_E_total);
			    two_MC_in_E_total=two_MC_in_E_total+two_MC_in_E[M];
			    two_MC_in_E_err_total=sqrt(two_MC_in_E_total);
                     }
//////////////////////////////////////efficiency///////////////////////////////////////////////////////
eff_data_ex_B_total=two_data_ex_B_total/moreone_data_ex_B_total;
eff_data_ex_B_err_total=sqrt(eff_data_ex_B_total*(1-eff_data_ex_B_total)/moreone_data_ex_B_total);
eff_data_in_B_total=two_data_in_B_total/moreone_data_in_B_total;
eff_data_in_B_err_total=sqrt(eff_data_in_B_total*(1-eff_data_in_B_total)/moreone_data_in_B_total);
eff_MC_ex_B_total=two_MC_ex_B_total/moreone_MC_ex_B_total;
eff_MC_ex_B_err_total=sqrt(eff_MC_ex_B_total*(1-eff_MC_ex_B_total)/moreone_MC_ex_B_total);
eff_MC_in_B_total=two_MC_in_B_total/moreone_MC_in_B_total;
eff_MC_in_B_err_total=sqrt(eff_MC_in_B_total*(1-eff_MC_in_B_total)/moreone_MC_in_B_total);
eff_data_ex_E_total=two_data_ex_E_total/moreone_data_ex_E_total;
eff_data_ex_E_err_total=sqrt(eff_data_ex_E_total*(1-eff_data_ex_E_total)/moreone_data_ex_E_total);
eff_data_in_E_total=two_data_in_E_total/moreone_data_in_E_total;
eff_data_in_E_err_total=sqrt(eff_data_in_E_total*(1-eff_data_in_E_total)/moreone_data_in_E_total);
eff_MC_ex_E_total=two_MC_ex_E_total/moreone_MC_ex_E_total;
eff_MC_ex_E_err_total=sqrt(eff_MC_ex_E_total*(1-eff_MC_ex_E_total)/moreone_MC_ex_E_total);
eff_MC_in_E_total=two_MC_in_E_total/moreone_MC_in_E_total;
eff_MC_in_E_err_total=sqrt(eff_MC_in_E_total*(1-eff_MC_in_E_total)/moreone_MC_in_E_total);


ratio_B_in_total=eff_data_in_B_total/eff_MC_in_B_total;
ratio_B_in_err_total=sqrt(pow(eff_data_in_B_err_total/eff_MC_in_B_total,2)+pow(eff_data_in_B_total*eff_MC_in_B_err_total,2)/pow(eff_MC_in_B_total,4));
ratio_B_ex_total=eff_data_ex_B_total/eff_MC_ex_B_total;
ratio_B_ex_err_total=sqrt(pow(eff_data_ex_B_err_total/eff_MC_ex_B_total,2)+pow(eff_data_ex_B_total*eff_MC_ex_B_err_total,2)/pow(eff_MC_ex_B_total,4));
ratio_E_in_total=eff_data_in_E_total/eff_MC_in_E_total;
ratio_E_in_err_total=sqrt(pow(eff_data_in_E_err_total/eff_MC_in_E_total,2)+pow(eff_data_in_E_total*eff_MC_in_E_err_total,2)/pow(eff_MC_in_E_total,4));
ratio_E_ex_total=eff_data_ex_E_total/eff_MC_ex_E_total;
ratio_E_ex_err_total=sqrt(pow(eff_data_ex_E_err_total/eff_MC_ex_E_total,2)+pow(eff_data_ex_E_total*eff_MC_ex_E_err_total,2)/pow(eff_MC_ex_E_total,4));

std::cout<<"eff MC in B"<<eff_MC_in_B_total<<"err="<<eff_MC_in_B_err_total<<std::endl;
std::cout<<"eff MC ex B"<<eff_MC_ex_B_total<<"err="<<eff_MC_ex_B_err_total<<std::endl;
std::cout<<"eff data in B"<<eff_data_in_B_total<<"err="<<eff_data_in_B_err_total<<std::endl;
std::cout<<"eff data ex B"<<eff_data_ex_B_total<<"err="<<eff_data_ex_B_err_total<<std::endl;
std::cout<<"eff MC in E"<<eff_MC_in_E_total<<"err="<<eff_MC_in_E_err_total<<std::endl;
std::cout<<"eff MC ex E"<<eff_MC_ex_E_total<<"err="<<eff_MC_ex_E_err_total<<std::endl;
std::cout<<"eff data in E"<<eff_data_in_E_total<<"err="<<eff_data_in_E_err_total<<std::endl;
std::cout<<"eff data ex E"<<eff_data_ex_E_total<<"err="<<eff_data_ex_E_err_total<<std::endl;

std::cout<<"SF in B"<<ratio_B_in_total<<"err="<<ratio_B_in_err_total<<std::endl;
std::cout<<"SF ex B"<<ratio_B_ex_total<<"err="<<ratio_B_ex_err_total<<std::endl;
std::cout<<"SF in E"<<ratio_E_in_total<<"err="<<ratio_E_in_err_total<<std::endl;
std::cout<<"SF ex E"<<ratio_E_ex_total<<"err="<<ratio_E_ex_err_total<<std::endl;
