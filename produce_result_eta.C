...
//   if(j%10000==0) std::cout<<"N="<<j<<std::endl;
 ...
 for(int L=0;L<N_bin_eta;L++){
                      moreone_data_ex[L]=moreone_N_data[L]-0.008366*(moreone_N_TT_1[L]+moreone_N_TT_2[L])-0.127428*(moreone_N_WJet_1[L]+moreone_N_WJet_2[L]);
			    moreone_data_ex_err[L]=sqrt(moreone_data_ex[L]);
                      two_data_ex[L]=two_N_data[L]-0.008366*(two_N_TT_1[L]+two_N_TT_2[L])-0.127428*(two_N_WJet_1[L]+two_N_WJet_2[L]);
			    two_data_ex_err[L]=sqrt(two_data_ex[L]);
                      moreone_MC_in[L]=0.02085*moreone_N_DY[L]+0.008366*(moreone_N_TT_1[L]+moreone_N_TT_2[L])+0.127428*(moreone_N_WJet_1[L]+moreone_N_WJet_2[L]);
			    moreone_MC_in_err[L]=sqrt(moreone_MC_in[L]);
                      two_MC_in[L]=0.02085*two_N_DY[L]+0.008366*(two_N_TT_1[L]+two_N_TT_2[L])+0.127428*(two_N_WJet_1[L]+two_N_WJet_2[L]);
			    two_MC_in_err[L]=sqrt(two_MC_in[L]);
                      moreone_MC_ex[L]=0.02085*moreone_N_DY[L]+0.016732*(moreone_N_TT_1[L]-moreone_N_TT_2[L])+0.254856*(moreone_N_WJet_1[L]-moreone_N_WJet_2[L]);
			    moreone_MC_ex_err[L]=sqrt(moreone_MC_ex[L]);
                      two_MC_ex[L]=0.02085*two_N_DY[L]+0.016732*(two_N_TT_1[L]-two_N_TT_2[L])+0.254856*(two_N_WJet_1[L]-two_N_WJet_2[L]);
